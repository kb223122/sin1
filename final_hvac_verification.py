#!/usr/bin/env python3
"""
Final HVAC Component Verification for 5-Zone Building
...
Uses environment: Eplus-5zone-zonal-hot-continuous-v1
"""
...
def run_final_hvac_verification():
    """Run final HVAC component verification."""
    ...
    try:
        ...
        print("✅ Environment 'Eplus-5zone-zonal-hot-continuous-v1' created successfully")
    except Exception as e:
        print(f"Error creating environment: {e}")
        print("Make sure the environment is properly registered in Sinergym")
        return False
    
    # Run verification
    print("\n" + "=" * 80)
    print("FINAL HVAC COMPONENT VERIFICATION")
    ...
    try:
        ...
        for step in range(10):  # Run 10 steps as requested
            ...
            if total_hvac_power > 0:
                ...
                all_components = {**central_components, **zone_components, **additional_cooling}
                for name, power in all_components.items():
                    if power > 0:
        ...
        if verification_data:
            ...
            print(f"Average Heating Error: {df['heating_percentage_error'].mean():.2f}%")
            ...
            df.to_csv('/workspace/final_hvac_verification_results.csv', index=False)
            print(f"\nDetailed results saved to: /workspace/final_hvac_verification_results.csv")
